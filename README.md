...
## AI
#### -이미지-이미지 변환(img2img) -Stable Diffusion v1.5     
...
#### -그림-이미지 변환(img2img) -Stable Diffusion v1
사용자가 원하는 사진에 원하는 가구를 그린 후 방을 생성합니다. negative 프롬프트를 내부적으로 조정하여 이미지를 실사화하여 적합한 이미지를 제공합니다.
